  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeInScale>
          <div className="rounded-md shadow-lg overflow-hidden grid grid-cols-1 lg:grid-cols-2 items-stretch">
            ...
            <SlideInLeft delay={0.2} className="bg-primary p-8 md:p-10 text-white flex flex-col">
              ...
              <div className="rounded-md overflow-hidden flex-1 min-h-[150px]">
                <iframe
